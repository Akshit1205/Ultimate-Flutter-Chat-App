...
class _AlertsState extends State<Alerts> {
  ...
  initiateSearch() {
    databaseMethods.alertSnapshot(Constants.myName).then((val) {
      setState(() {
        chatroomStream = val;
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Alerts"), actions: [
        GestureDetector(
          onTap: () {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        databaseMethods.deleteAlert(widget.username, Constants.myName);
      },
      child: Container(
        color: Colors.black,
